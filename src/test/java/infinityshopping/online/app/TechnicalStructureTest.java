...
@AnalyzeClasses(packagesOf = InfinityShoppingStoreApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(InfinityShoppingStoreApp.class), alwaysTrue())
